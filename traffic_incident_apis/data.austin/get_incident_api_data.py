...
traffic_incidents["Street"] = traffic_incidents["Address"].str.extract("(LAMAR)", expand = True)
traffic_incidents["RecordDate"] = traffic_incidents["IncidentDate"].str.extract("(\d+-\d+-\d+)", expand = True)
